...
//SuiteOneCaseThree Class Inherits From SuiteOneBase Class.
//So, SuiteOneCaseThree Class Is Child Class Of SuiteOneBase Class And SuiteBase Class.
public class SuiteOneCaseThree extends SuiteOneBase{
	...
	@Test(dataProvider="SuiteOneCaseThreeData")
	public void SuiteOneCaseThreeTest(String DataCol1,String DataCol2,String DataCol3,String ExpectedResult){
	...
	@DataProvider
	public Object[][] SuiteOneCaseThreeData(){
		//To retrieve data from Data 1 Column,Data 2 Column,Data 3 Column and Expected Result column of SuiteOneCaseThree data Sheet.
